...
const winnerInformation = document.querySelector('.winner-info');
...
const init = function () {
  ...
  winnerInformation.classList.add('hidden');
};
...
btnHold.addEventListener('click', function () {
  if (playing) {
    ...
    if (scores[activePlayer] >= 20) {
      ...
      winnerInformation.textContent = ` Congratulations 🎉Player ${activePlayer + 1} Wins the Game 🥇`;
    } else {
